...
TRACKS = [
    {"id": "nikes", "title": "Nikes", "album_id": "blonde", "artist_id": "frank-ocean", "duration": "5:14",
     "key_line": "we'll let you guys prophesy",
...
CONNECTIONS = [
    ...
    {"source": "nikes", "target": "earfquake", "type": "mood-cousin", "weight": 0.7},
    {"source": "self-control", "target": "the-weekend", "type": "mood-cousin", "weight": 0.8},
    {"source": "alright", "target": "u", "type": "album-sibling", "weight": 1.0},
    {"source": "u", "target": "mirror-confrontation", "type": "mood-anchor", "weight": 0.9},
    ...
    {"source": "the-weekend", "target": "earfquake", "type": "mood-cousin", "weight": 0.7},
    {"source": "money-machine", "target": "earfquake", "type": "production-lineage", "weight": 0.5},
    {"source": "nights", "target": "weird-fishes", "type": "mood-cousin", "weight": 0.6},
