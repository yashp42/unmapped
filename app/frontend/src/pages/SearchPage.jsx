...
export default function SearchPage() {
  ...
  const [r, setR] = useState({ tracks: [], albums: [], artists: [], lore: [] });
  ...
  return (
    <div className="max-w-[1480px] mx-auto px-6 py-12">
      ...
      {Object.values(r).every((x) => x.length === 0) && <p className="font-editorial italic text-xl mt-8">no results. try an artist, album, track, or lore keyword.</p>}
    </div>
  );
}
