      ...
      <div className="max-w-[1480px] mx-auto px-6 py-3 flex items-center gap-6">
        ...
        {user ? (
          <div className="flex items-center gap-2">
            ...
            {user.role === "admin" && (
              <><Link to="/admin" className="brutal-btn accent !py-1.5 !px-3 text-sm" data-testid="admin-link">admin</Link><Link to="/admin/moderation" className="brutal-btn invert !py-1.5 !px-3 text-sm">review</Link></>
            )}
